...
def get_image():
    ...
    response = requests.get(f"https://www.pexels.com/zh-tw/search/{input_image}") # https://www.pexels.com/zh-tw/search/dog/
    print(f"https://www.pexels.com/zh-tw/search/{input_image}")
    soup = BeautifulSoup(response.text, "lxml")
    results = soup.find_all('a', class_="js-photo-link")
    print(results)
